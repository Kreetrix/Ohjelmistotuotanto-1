...
-- Dumping structure for table card_memory_db.app_users
...
-- Dumping data for table card_memory_db.app_users: ~2 rows (approximately)
...
-- Dumping structure for table card_memory_db.cardhistory
...
-- Dumping data for table card_memory_db.cardhistory: ~0 rows (approximately)
DELETE FROM `cardhistory`;

-- Dumping structure for table card_memory_db.cards
...
-- Dumping data for table card_memory_db.cards: ~4 rows (approximately)
DELETE FROM `cards`;
...
-- Dumping structure for table card_memory_db.deckassignments
...
-- Dumping data for table card_memory_db.deckassignments: ~1 rows (approximately)
...
-- Dumping structure for table card_memory_db.deckhistory
...
-- Dumping data for table card_memory_db.deckhistory: ~0 rows (approximately)
DELETE FROM `deckhistory`;

-- Dumping structure for table card_memory_db.decks
...
-- Dumping data for table card_memory_db.decks: ~2 rows (approximately)
DELETE FROM `decks`;
...
-- Dumping structure for table card_memory_db.gamesessions
...
-- Dumping data for table card_memory_db.gamesessions: ~0 rows (approximately)
DELETE FROM `gamesessions`;

-- Dumping structure for table card_memory_db.localization
...
-- Dumping data for table card_memory_db.localization: ~0 rows (approximately)
DELETE FROM `localization`;

-- Dumping structure for table card_memory_db.sessionresults
...
-- Dumping data for table card_memory_db.sessionresults: ~0 rows (approximately)
